...
| **Packet capture & analysis** | Standalone **live capture** and **offline pcap/pcapng analysis** via **tshark/Npcap**; complements optional capture in network diagnosis. See [`docs/packet-capture-design.md`](docs/packet-capture-design.md). Reports under `reports/packet_capture/`. |
